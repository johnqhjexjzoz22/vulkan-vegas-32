...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-6052ff0a');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-6052ff0a');}
...
var brandEl=document.querySelector('.rl-brand-6052ff0a');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
